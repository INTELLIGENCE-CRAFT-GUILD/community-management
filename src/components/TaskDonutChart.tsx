...
const CustomTooltip: React.FC<CustomTooltipProps> = ({ active, payload }) => {
  if (active && payload && payload.length) {
    return (
      <div className="rounded-lg border border-wood-600/10 bg-wood-800/95 px-4 py-3 shadow-xl backdrop-blur-md">
...
export const TaskDonutChart: React.FC<TaskDonutChartProps> = ({ data }) => {
  ...
  return (
    <div className="relative rounded-2xl border border-wood-600/10 bg-wood-700/30 p-8 backdrop-blur-sm">
      <div className="mb-6">
